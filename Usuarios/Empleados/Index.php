    ...
    foreach($cmd as $fila) {
     echo "<tr>";
      ...
      echo '<td style="height:60px"><div class="d-flex flex-row" style="justify-content:center; align-items:center !important; height:100%">';
       ...
       echo '<div class="px-1"><a href="Update.php?iId='.$fila["iIdUsuario"].'" class="btn btn-primary btn-sm py-2"><i class="far fa-edit mr-2"></i>Modificar</a></div>'; 
       echo '<div class="px-1"><a href="Delete.php?iId='.$fila["iIdUsuario"].'" class="btn btn-danger btn-sm py-2"><i class="far fa-trash-alt mr-2"></i>Eliminar</a></div>';
