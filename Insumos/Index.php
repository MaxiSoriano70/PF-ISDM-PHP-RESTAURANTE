    ...
    foreach($cmd as $fila) {
     echo "<tr>";           
      ...
      echo '<td><div class="d-flex flex-row" style="justify-content:center;">';                                
       echo '<div class="p-1"><a href="Update.php?iId='.$fila["iIdInsumo"].'" class="btn btn-primary btn-sm py-2"><i class="far fa-edit mr-2"></i>Modificar</a></div>'; 

       if ($fila['bEliminado']==0) {
        echo '<div class="p-1"><a href="Delete.php?iId='.$fila["iIdInsumo"].'" class="btn btn-danger btn-sm py-2"><i class="far fa-trash-alt mr-2"></i>Eliminar</a></div>';
       }
                                             
       else { 
        echo '<div class="p-1"><a href="Recuperar.php?iId='.$fila["iIdInsumo"].'" class="btn btn-secondary btn-sm py-2" style="color:#fff"><i class="fas fa-trash-restore-alt mr-2"></i>Restore</a></div>';
       }
