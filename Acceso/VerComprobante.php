<?php
 ...
 require '../PDF/Compras-Usuario/index.php';
 ...
 if (!empty($_GET['iId'])) {
    ...
    $sql="SELECT v.iIdVenta,dFecha,fTotal,SUM(d.iCantidad) AS iCantidad,u.sNombre,sApellido,iContacto,sEmail FROM Ventas v 
